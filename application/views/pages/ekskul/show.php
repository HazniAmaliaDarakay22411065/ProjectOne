                ...
                <?php foreach ($ekskul as $e) : ?>
                    <div class="col-12 col-sm-6 col-md-3 mb-4">
                        <div class="card h-100 shadow-sm border-0" style="border-radius: 12px;">
                            <img src="<?= base_url('images/ekskul/' . $e->image) ?>"
                                class="card-img-top"
                                alt="<?= $e->judul ?>"
                            ...
                            <div class="card-body text-center p-3"
                                ...
                                <h6 class="text-dark mb-2" style="font-size: 15px; font-weight: 600;">
                                    <?= strtoupper($e->judul) ?>
                                </h6>
                                ...
                                <p class="mb-0 text-muted" style="font-size: 14px; font-weight: 500;">
                                    <?= ucwords($e->guru_nama) ?>
                                </p>
                            </div>
                        </div>
