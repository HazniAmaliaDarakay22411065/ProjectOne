                ...
                <?php foreach ($kegiatan as $item) : ?>
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-3">
                        <div class="card h-100 text-center">
                            <img src="<?= base_url("images/kegiatan_masyarakat/$item->image") ?>" alt="<?= $item->judul ?>" class="card-img-top rounded-top-4" style="height: 200px; object-fit: cover;">
                            <div class="card-body d-flex flex-column">
                                <h5 class="post-title mb-2" style="font-size: 18px; font-weight: bold;">
                                    <?= $item->judul ?>
                                </h5>
                                <p class="post-content" style="font-size: 14px; color: #000;">
                                    <?= word_limiter(strip_tags($item->deskripsi), 20) ?>
                                </p>
