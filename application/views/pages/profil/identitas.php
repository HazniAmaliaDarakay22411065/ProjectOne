    ...
    <div class="container">
        ...
        <div class="container bg-light text-dark" style="max-width: 800px; margin: 0 auto; margin-top: 10rem; padding: 2rem; border-radius: 15px; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.1); background: linear-gradient(to bottom right, #f8f9fa, #e9ecef);">
            <div class="container-galeri text-center">
                <h3 style="font-family: 'Rowdies', serif; font-weight: bold; color: #343a40;">PROFIL SEKOLAH</h3>
            ...
            <?php if ($profil) : ?>
                <table class="table table-bordered w-100 mt-4">
                    <tr>
                        <th>Nama Sekolah</th>
                        <td><?= html_escape($profil->nama_sekolah) ?></td>
                    </tr>
                    <tr>
                        <th>NPSN</th>
                        <td><?= html_escape($profil->npsn) ?></td>
                    </tr>
                    <tr>
                        <th>Jenjang</th>
                        <td><?= html_escape($profil->jenjang) ?></td>
                    </tr>
                    <tr>
                        <th>Status</th>
                        <td><?= html_escape($profil->status) ?></td>
                    </tr>
                    <tr>
                        <th>Akreditasi</th>
                        <td><?= html_escape($profil->akreditasi) ?></td>
                    </tr>
                    <tr>
                        <th>Tahun Berdiri</th>
                        <td><?= html_escape($profil->tahun_berdiri) ?></td>
                    </tr>
                </table>
            <?php else : ?>
